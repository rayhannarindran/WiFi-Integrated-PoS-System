    ...
    <div className="App">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button type="button" onClick={() => setShowBackend(!showBackend)}>
          {showBackend ? 'Hide' : 'Show'} Backend Variables
        </button>
        {showBackend && (
        ...
        <button type="button" onClick={() => setShowMikrotik(!showMikrotik)}>
          {showMikrotik ? 'Hide' : 'Show'} MikroTik Variables
        </button>
        {showMikrotik && (
          <div className="section">
            <div>
        ...
        <button type="button" onClick={() => setShowPrinter(!showPrinter)}>
          {showPrinter ? 'Hide' : 'Show'} Printer Variables
        </button>
        {showPrinter && (
          <div className="section">
            <div>
        ...
        <button type="button" onClick={() => setShowNetworkSpec(!showNetworkSpec)}>
          {showNetworkSpec ? 'Hide' : 'Show'} Network Spec Variables
        </button>
        {showNetworkSpec && (
          <div className="section">
            <div>
